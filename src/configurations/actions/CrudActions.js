...
export const ITCrudGetList = (params) => {
...
export const ITCrudGetAll = ({ ...params }) => {
...
export const ITCrudGetOne = ({ ...params }) => {
...
export const ITCrudCreate = (params) => {
...
export const ITCrudUpdate = (params) => {
...
export const ITCrudUpdateMany = (params) => {
...
export const ITCrudDelete = ({ ...params }) => {
...
export const ITCrudDeleteMany = ({ ...params }) => {
...
export const ITCrudGetMany = (resource, ids) => ({
...
export const ITCrudGetMatching = ({ ...params }) => {
...
export const ITCrudGetManyReference = ({ ...params }) => {
